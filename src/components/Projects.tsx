...
const projects = [
  {
    ...
    problem:
      "Hospitals lacked a low-cost way to track patient vitals remotely.",
  ...
  },
  {
    ...
    impact:
      "Eliminated data entry errors and saved administrative time tracking.",
    image:
  ...
  },
  {
    ...
    impact:
      "Generated consistent online sales within the first month of launch.",
    image:
...
export default function Projects() {
  ...
  return (
    <section
      id="projects"
      ref={sectionRef}
      className="relative z-10 bg-[#0B0B0F]"
    >
      <div className="h-screen flex flex-col items-center justify-center px-4 max-w-7xl mx-auto pt-20">
        <div className="text-center mb-12 flex-shrink-0">
          ...
          <p className="text-xl text-gray-400 max-w-2xl mx-auto hidden sm:block">
            Showcasing real business problems, my tailored solutions, and the
            impact they made.
          </p>
        </div>
            ...
            >
              ...
              <div className="w-full md:w-1/2 p-5 sm:p-6 md:p-10 flex flex-col justify-center relative z-10 bg-[#111116]/90 md:bg-transparent backdrop-blur-md md:backdrop-blur-none flex-1 overflow-y-auto">
                ...
                <div className="space-y-3 sm:space-y-4 mb-6 md:mb-8 text-sm sm:text-base">
                  <div>
                    <span className="text-[#22D3EE] font-semibold block mb-0.5 md:mb-1 text-xs uppercase tracking-wider">
                      The Problem
                    </span>
                  ...
                  <div>
                    <span className="text-[#8B5CF6] font-semibold block mb-0.5 md:mb-1 text-xs uppercase tracking-wider">
                      The Solution
                    </span>
                    <p className="text-gray-400 leading-snug">
                      {project.solution}
                  ...
                  <div>
                    <span className="text-[#10B981] font-semibold block mb-0.5 md:mb-1 text-xs uppercase tracking-wider">
                      The Impact
                    </span>
