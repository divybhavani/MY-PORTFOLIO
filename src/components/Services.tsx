...
const services = [
  {
    ...
    icon: Monitor,
    desc: "Creating modern responsive websites with clean UI.",
  },
  {
    title: "Backend Development",
    icon: Server,
    desc: "Building secure and scalable backend systems.",
  },
  {
    title: "App Development",
    icon: Smartphone,
    desc: "Developing high-performance mobile and web apps.",
  },
  {
    title: "API Development",
    icon: Code2,
    desc: "Designing fast and reliable REST APIs.",
  },
  {
    title: "Database Design",
    icon: Database,
    desc: "Structuring efficient and scalable databases.",
  },
];
        ...
        (context) => {
          ...
          const tl = gsap.timeline({
            scrollTrigger: {
              ...
              pin: true,
              scrub: isDesktop ? 1 : 0.1, // Much smaller scrub delay for mobile to reduce 'stuck' feeling
            },
          });
      ...
      <div className="h-screen flex flex-col items-center justify-center px-4 max-w-7xl mx-auto pt-20">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            Delivering premium digital solutions tailored to your business
            needs.
          </p>
        </div>
